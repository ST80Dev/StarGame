...
|---|---|---|---|
| **Superficie** | `--c-surface-rgb` | `34 46 86` (navy) | pannelli, card, sheet, schede colonia. Si usa come `rgb(var(--c-surface-rgb) / .xx)` — l'**alpha vive per-uso**, l'RGB è unico. `--c-panel`/`--c-panel-solid` derivano da qui. |
| **Superficie viola** | `--c-surface-violet-rgb` | `46 34 78` | superfici a tinta viola (commander, blocchi viola). |
| **Fondo profondo** | `--c-bg-deep-rgb` | `22 30 64` | viewport (dietro la mappa) e Dashboard Impero. |
