...
```
stargame/
├── index.html          ✅ shell UI + caricamento moduli M02/M03/M04/M05
├── css/
│   └── style.css        ✅ tema scuro + mappa (M02) + sistema (M03) + scheda pianeta (M04) + pulse HUD/scarsità/progress (M05)
├── js/
