...
- **Vista più pulita.** Nebulose 10→6, alpha 0.04-0.11 → 0.02-0.055, raggio leggermente ridotto. Rimosso il `globalCompositeOperation = 'lighter'` sulle nebulose (era responsabile della saturazione cumulativa che pervadeva la mappa). Stelle eroe 8→4 (decorative ma non saturanti).
