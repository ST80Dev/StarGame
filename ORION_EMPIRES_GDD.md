...
├── js/
│   ├── main.js             ← inizializzazione, game loop, gestione turni
...
**HUD:** Pannelli fissi con risorse, turno corrente, indice corruzione galattica, notifiche eventi  

---

## 4. TEMPO E TURNI

**Principio fondamentale:** Il tempo scorre quando il giocatore lo fa scorrere. Nessuna attesa reale.  
**Unità base:** 1 turno = ~1 mese di gioco simulato  
**Controllo:** Pulsante "Avanza Turno" (o "Avanza X Turni")  
**Salvataggio:** Possibile in qualsiasi momento, anche a metà turno  

**Esempi di costi temporali:**
- Struttura base (miniera semplice): 3-5 turni
- Struttura avanzata (cantiere navale): 15-25 turni
- Caccia leggero: 3 turni
- Fregata: 20-30 turni
- Dreadnought: 60-80 turni
- Stazione orbitale: 40-50 turni
- Tecnologia base: 10-20 turni
- Tecnologia avanzata: 50-100 turni
- Colonizzazione secondo pianeta stesso sistema: 30-50 turni + risorse

**Interconnessione eventi-tempo:**  
Tutto fluisce in modo continuo. Gli eventi hanno conseguenze temporali (un embargo dura X turni, una guerra cambia rotte, una carestia rallenta costruzioni). Niente è isolato.
...
- Colonizzare un secondo corpo richiede: tecnologia specifica + infrastruttura consolidata sul primo + risorse significative + tempo (30-50 turni)
...
- Risorse avanzate: si scoprono costruendo strutture esplorative, dopo X turni, o tramite eventi
...
- Il giocatore ha sempre un turno di preavviso negli eventi

### 7.5 Mercato interno
- Pianeti colonizzati possono rifornirsi a vicenda
- Costo di trasporto proporzionale alla distanza (turni + risorse)
...
| Media | Significativo | Qualche turno instabilità, fattibile |
| Grande | Alto | Traumatico, molti turni, rischio eventi |
...
**Due modalità:**
1. **Graduale:** X turni con due capitali parziali, bonus dimezzati su entrambe — meno traumatico
...
### 9.3 Crescita
- La popolazione cresce automaticamente ogni turno in base a: cibo, acqua, morale, strutture abitative
...
Il Consiglio interviene tramite **eventi testuali** periodici — non ogni turno. Il giocatore può ignorare i suggerimenti ma con possibili conseguenze non immediate.
...
- Ogni struttura ha costo in risorse + tempo (turni)
...
- Gestione non dettagliata: si attivano, generano flusso automatico ogni turno
...
- Si mandano agenti in sistemi nemici (costo risorse + turni viaggio)
...
- Pannello "notiziario" aggiornato ogni X turni
...
4. **[M04] Pianeta base** — Risorse, strutture, popolazione, turni, costruzione
5. **[M05] Turni e tempo** — Game loop, avanzamento turno, timer costruzioni
...
- **La galassia vive** — le AI agiscono anche quando il giocatore non avanza turni (al prossimo avanzamento vengono processati i turni AI).
