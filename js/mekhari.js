/* =====================================================================
   ...
   RINVIATO (dipende da moduli futuri):
     - (a) MERCATO SECONDARIO di risorse avanzate §7.2 → M13 ·
       (c) contratti mercenari → M14 · (d) taglie pirata → M17.

   NB (decisione utente 2026-06-30): i Mekhari NON vendono informazioni sulle
   altre civiltà — quello è il ruolo del CONCLAVE DI VEHRYN (§13.7), vedi
   js/vehryn.js. I Mekhari restano il TRAFFICANTE (merci/contrabbando), non
   l'informatore.
