  ...
  const LESSONS = [
    ...
    },
    {
      ...
      body:
        ...
        'la copia locale viene conservata come <strong>backup automatico</strong> nel pannello Save ' +
        '(ultimi 5, recovery-friendly). Da lì puoi scaricarli come <code>.json</code> quando vuoi. ' +
        'Puoi disabilitare la sincronia dal pannello Save.</p>' +
    ...
    },
    {
      ...
      body:
        ...
        '<p><strong>Razioni equipaggio al porto:</strong> ogni <em>equipaggio idle</em> sulla colonia (in attesa di una missione) ' +
        'consuma <strong>un po\' di cibo e acqua</strong> (squadre specializzate ben nutrite). Per equipaggio è poco; in totale si ' +
        '<em>sente</em> quando 6-10 equipaggi attendono insieme su una colonia piccola — lanciare una spedizione li toglie dal libro paga. ' +
        'I crews delle <em>flotte</em> (in viaggio o ferme) non pagano qui: mangiano dai <em>viveri della flotta</em>, già reintegrati al porto.</p>' +
